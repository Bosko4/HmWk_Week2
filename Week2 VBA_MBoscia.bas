...
'Step 5 - Formating
 ...
 'First attempt at conditional formatting...Swing and a miss.
     'Dim j As Integer
...
'Conditional Formatting....got a little help from Google for this part
...
Set SumRg = ws.Range("K2", "K" & (Summary_Row - 1))

'define the rule for each conditional format
Set cond1 = SumRg.FormatConditions.Add(xlCellValue, xlGreater, "0")
Set cond2 = SumRg.FormatConditions.Add(xlCellValue, xlLess, "1")
